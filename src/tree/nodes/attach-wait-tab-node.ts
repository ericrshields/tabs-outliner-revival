/**
 * AttachWaitTabTreeNode — a tab waiting to be attached to a window.
 *
 * Port of legacy NodeTabAttachWait. An active tab variant that behaves
...
export class AttachWaitTabTreeNode extends TreeNode {
  readonly type = NodeTypesEnum.ATTACHWAITINGTAB;
  readonly titleCssClass = 'attachwaitingtab';
